...
-fp /storage/brno12-cerit/home/drking/experiments/SCL-actions/hdm05/all/lat_dim=${DIM}_beta=${BETA}/predictions_model=hdm05.data \
-k 4 \
--scl \
...
COMMAND="${JDK_PATH} -jar /storage/brno12-cerit/home/drking/experiments/mocap-vae-features/evaluator.jar \
-fp /storage/brno12-cerit/home/drking/experiments/SCL-actions/pku-mmd/cv/lat_dim=${DIM}_beta=${BETA}/predictions_model=pku-mmd.data \
-cv \
-k 4 \
--scl \
