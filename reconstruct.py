...
def main(args):
    ...
    ckpt = Path("runs/hdm05/all/beta=1,latent_dim=16/lightning_logs/version_0/checkpoints").glob('epoch*.ckpt')
    ckpt = next(iter(ckpt))
    ...
    gif_dir = Path("runs/hdm05/all/beta=1,latent_dim=16/lightning_logs/version_0") / 'reconstructions3'
