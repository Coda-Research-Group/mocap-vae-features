...
"
    ...
    eval "${COMMAND}" >> "/storage/brno12-cerit/home/drking/experiments/baseline-skeleton/cv/results-67.txt"
# fi
# if [[ "${SET}" == "cs" ]]; then
#     COMMAND="${JDK_PATH} -jar /storage/brno12-cerit/home/drking/experiments/mocap-vae-features/evaluator.jar \
# -fp /storage/brno12-cerit/home/drking/data/pku-mmd/actions-single-subject-all-POS-fps10.data \
...
#     eval "${COMMAND}" >> "/storage/brno12-cerit/home/drking/experiments/baseline-skeleton/cs/results-67.txt"
# fi
# #---------------------------------------------------------------------------------------------------------------
# if [[ "${SET}" == "alln" ]]; then
#     COMMAND="${JDK_PATH} -jar /storage/brno12-cerit/home/drking/experiments/mocap-vae-features/evaluator.jar \
