...
-dd /storage/brno12-cerit/home/drking/data/hdm05/category_description.txt \
"
    mkdir -p "/storage/brno12-cerit/home/drking/experiments/elki-results/hdm05/composite"
    eval "${COMMAND}" >> "/storage/brno12-cerit/home/drking/experiments/elki-results/hdm05/composite/dim=${DIM}_beta=${BETA}_${K}.txt"
...
-dd /storage/brno12-cerit/home/drking/data/hdm05/category_description.txt \
"
    mkdir -p "/storage/brno12-cerit/home/drking/experiments/elki-results/hdm05/composite-non-norm"
    eval "${COMMAND}" >> "/storage/brno12-cerit/home/drking/experiments/elki-results/hdm05/composite-non-norm/dim=${DIM}_beta=${BETA}_${K}.txt"
