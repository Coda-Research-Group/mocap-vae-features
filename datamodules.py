...
if __name__ == "__main__":
    ...
    train_split = '/storage/brno12-cerit/home/drking/data/hdm05/2folds20_80split_2-class122.txt'
    test_split = '/storage/brno12-cerit/home/drking/data/hdm05/2folds20_80split_1-class122.txt'
    dm = MoCapDataModule(
        data_path,
        train=train_split,
        valid=test_split,
