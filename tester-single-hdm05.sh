...
for K in 10 20 35 50 60 80 100 150 200 250 300 350 400 500 750 1000 1250 1500 1750 2000 2500; do
    ...
    rm "/storage/brno12-cerit/home/drking/experiments/results/hdm05/all/hdm05_lat_dim=${DIM}_beta=${BETA}/${K}/results-${ITER}.txt"
...
-k 4 \
"
    mkdir -p "/storage/brno12-cerit/home/drking/experiments/results/hdm05/all/hdm05_lat_dim=${DIM}_beta=${BETA}/${K}/"
    eval "${COMMAND}" >> "/storage/brno12-cerit/home/drking/experiments/results/hdm05/all/hdm05_lat_dim=${DIM}_beta=${BETA}/${K}/results-${ITER}.txt"
