...
-fp /storage/brno12-cerit/home/drking/experiments/SCL-segmented-actions-norm/hdm05/all/lat_dim=${DIM}_beta=${BETA}/MWs-parts-M/KMeansPivotChooser--kmeans.k_${K}.composite \
-k 4 \
--nmatches 2 \
...
"
    ...
    eval "${COMMAND}" >> "/storage/brno12-cerit/home/drking/experiments/results/hdm05/all/lat_dim=${DIM}_beta=${BETA}/results-norm.txt"
