...
/**
 * Rerank hulls retreived by an operation using the original distance (not changed) and a sub-distance defined as a match of class to the query object.
 *
 * @author Vlastislav Dohnal, Masaryk University, Brno, Czech Republic, dohnal@fi.muni.cz
 */
public class HullClassRerankingCollection extends RankedSortedCollection implements InstantiableCollection {
    
    private SequenceMocapSegment query;

    public HullClassRerankingCollection(AbstractObject queryObject) {
    ...
    public synchronized boolean add(RankedAbstractObject e) {
        ...
        return super.add(new RankedAbstractMetaObject(e.getObject(), dist, null));
    }
