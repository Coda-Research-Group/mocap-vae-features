 ...
 */
public class SequenceSegmentCodeListCosineDTW extends AbstractEditDistanceFunction {
    ...
    public SequenceSegmentCodeListCosineDTW(BitSet jointIndexMask) {
    ...
    public static class Parameterizer extends AbstractParameterizer {
         ...
         * See {@link SequenceSegmentCodeListCosineDTW#jointIndexMask}.
         */
        ...
        @Override
        protected SequenceSegmentCodeListCosineDTW makeInstance() {
            ...
            return new SequenceSegmentCodeListCosineDTW(jointIndicesMask);
        }
