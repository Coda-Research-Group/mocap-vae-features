...
function createCompositeMWClusteringMessif() {
    ...
    for K in 10 20 35 50 60 80 100 150 200 250 300 350 400 500 750 1000 1250 1500 1750 2000 2500; do
        ...
        DATASET_PATH="/storage/brno12-cerit/home/drking/experiments/SCL/hdm05/all/model\=hdm05-${PART}_lat-dim\=8_beta\=0.1/${ITER}/predictions_segmented.data.gz"
        ROOT_FOLDER_FOR_RESULTS="/storage/brno12-cerit/home/drking/experiments/clusters/hdm05/${PART}-norm/${ITER}/${K}/"
