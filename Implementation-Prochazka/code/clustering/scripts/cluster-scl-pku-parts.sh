...
#PBS -l select=1:ncpus=4:mem=8gb:scratch_local=16gb
#PBS -o /dev/null
#PBS -e /dev/null
...
function createCompositeMWClusteringMessif() {
    ...
    for K in 100 150 200 250 300 350 400 500 750 1000 1250 1500 1750 2000 2500 3500 5000 7500 10000 15000; do
        ...
        DATASET_PATH="/storage/brno12-cerit/home/drking/experiments/SCL-non-norm/pku-mmd/${SETUP}/model\=${PART}_lat-dim\=${DIM}_beta\=${BETA}/${ITER}/predictions_segmented.data-train"
