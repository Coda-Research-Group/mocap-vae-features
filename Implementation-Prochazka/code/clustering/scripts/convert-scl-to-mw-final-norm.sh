...
for K in "1000" "2000" "3000" "4000" "5000" "6000" "7000" "8000" "9000" "10000"; do
	...
	CLUSTER_FOLDER_PATH="/storage/brno12-cerit/home/drking/experiments/SCL-segmented-actions-norm/pku-mmd/${DATA}/lat_dim=${DIM}_beta=${BETA}/clusters-${PART}/KMedoidsFastPAM--kmeans.k_${K}"
