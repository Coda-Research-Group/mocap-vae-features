...
//        Class<? extends  LocalAbstractObject> objectClass = SequenceSegmentCodeListDTW.class;
        ...
        ObjectMotionWordSoftAssignment.maxPartsToMatch = 5;
...
//        int[] fixedKsToEvaluate = new int[]{};
        int[] fixedKsToEvaluate = new int[]{1,4};
...
//        final String batchNamePrefix = "/home/drking/Documents/bakalarka/data/SCL/cluster_test/sequence/";
        // Mounted hardisk
...
//        final String batchNamePrefix = "/home/drking/Documents/bakalarka/data/SCL/cluster_test/results/pku-mmd/Cosine/MW/KMeansPivotChooser--kmeans.k_3000/";
//        final String batchNamePrefix = "/home/drking/Documents/bakalarka/data/SCL/cluster_test/results/Cosine/MW/KMeansPivotChooser--kmeans.k_350/";
        final String batchNamePrefix = "/home/drking/Documents/bakalarka/data/pku-mmd/MW/";

        String[] lat_dims = new String[]{"64", "32", "16", "8", "4"};
        String[] betas = new String[]{"0.1", "1", "10"};
        String[] ks = new String[]{"5", "10", "20", "50", "100", "150", "200", "250", "300", "350", "400", "500", "600", "750"};
        List<String> files = new ArrayList<>();
        for (String dim: lat_dims) {
            for (String bet: betas) {
                for (String k: ks) {
                    files.add("Elki_"+ dim +"_"+ bet +"_"+ k +".composite");
                }
            }
        }
...
//                "L2/test/MW/KMeansPivotChooser--kmeans.k_350/FULL.D0K1",
//                "L1/test/MW/KMeansPivotChooser--kmeans.k_350/FULL.D0K1",
//                "Lmax/test/MW/KMeansPivotChooser--kmeans.k_350/FULL.D0K1",
//                "Cosine/test/MW/KMeansPivotChooser--kmeans.k_350/FULL.D0K1",
//                "EuclideanCosine/test/MW/KMeansPivotChooser--kmeans.k_350/FULL.D0K1",
//                "NeuralNetworkL2/test/MW/KMeansPivotChooser--kmeans.k_350/FULL.D0K1"
//                "predictions_model=hdm05.data"
//                "predictions_model=pku-mmd.data"
//                "Cosine.D0.2K5"
//                "actions-single-subject-all-POS-fps10.data"
//                "KMeansPivotChooser--kmeans.k_5/parts.composite",
//                "KMeansPivotChooser--kmeans.k_10/parts.composite",
//                "KMeansPivotChooser--kmeans.k_20/parts.composite",
//                "KMeansPivotChooser--kmeans.k_50/parts.composite",
//                "KMeansPivotChooser--kmeans.k_100/parts.composite",
//                "KMeansPivotChooser--kmeans.k_150/parts.composite",
//                "KMeansPivotChooser--kmeans.k_200/parts.composite",
//                "KMeansPivotChooser--kmeans.k_250/parts.composite",
//                "KMeansPivotChooser--kmeans.k_300/parts.composite",
//                "KMeansPivotChooser--kmeans.k_350/parts.composite",
//                "KMeansPivotChooser--kmeans.k_400/parts.composite",
//                "KMeansPivotChooser--kmeans.k_500/parts.composite",
//                "KMeansPivotChooser--kmeans.k_600/parts.composite",
//                "KMeansPivotChooser--kmeans.k_750/parts.composite"
//                "Cosine/MW/FULL.D0.01K5",
                "FULL.D0K1"
//                "KMeansPivotChooser--kmeans.k_350-train-extended.composite"



        }){
//        for (String batchNameFile : files){
