...
for K in 10 20 35 50 60 80 100 150 200 250 300 350 400 500 750 1000 1250 1500 1750 2000 2500; do
    ...
    rm "/storage/brno12-cerit/home/drking/experiments/results/hdm05/all/${PART}_lat_dim=${DIM}_beta=${BETA}/${K}/results.txt"

    COMMAND="${JDK_PATH} -jar /storage/brno12-cerit/home/drking/experiments/mocap-vae-features/evaluator.jar \
-fp /storage/brno12-cerit/home/drking/experiments/MWs/hdm05/all/model=${PART}_lat-dim=${DIM}_beta=${BETA}/KMeansPivotChooser--kmeans.k_${K} \
...
"
    ...
    eval "${COMMAND}" >> "/storage/brno12-cerit/home/drking/experiments/results/hdm05/all/${PART}_lat_dim=${DIM}_beta=${BETA}/results.txt"
